...
<bean class="org.springframework.beans.factory.config.CustomEditorConfigurer">
    <property name="customEditors">
        <map>
            <entry key="com.zhengpeidong.springtest.domain.Car" value="com.zhengpeidong.springtest.protiest.CustomCarEditor"/>
        </map>
    </property>
</bean>
最后对于Car，我们可以这样配置：
<bean id="boss" class="com.zhengpeidong.springtest.domain.Boss">
    <property name="car" value="dcc,18"/>
</bean>
注：如果觉得注册此属性编辑器太麻烦，可以和JDK一样，使用约定大于配置：
com.zhengpeidong.domain.CarEditor会自动成为com.zhengpeidong.domian.Car的属性编辑器，这样就可以不用配置，Spring会自动注册对应的Car
占位符：
...
配置如下：
 <bean class="com.zhengpeidong.springtest.domain.EncryptPropertyTest"
...
<bean id="messageSource" class="org.springframework.context.support.ResourceBundleMessageSource">
    <property name="basenames">
        <list>
            <value>com/zhengpeidong/fmt_resource</value>
        </list>
    </property>
</bean>
